...
export function NewHabitForm() {
  ...
  function handleToggleWeekDay(weekDayParam: number) {
    if (weekDays.includes(weekDayParam)) {
      setWeekDays((prevState) =>
        prevState.filter((day) => day !== weekDayParam)
      );
    } else {
      setWeekDays((prevState) => [...prevState, weekDayParam]);
    }
  }
